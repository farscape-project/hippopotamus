 ...
 */
class DualDivField : public Kernel
{
public:
  static InputParameters validParams();

  DualDivField(const InputParameters & parameters);
...
protected:
  ...
  const VectorVariableValue & _coupled_u;

  /// div of the shape function of the coupled vector variable
  const VectorVariablePhiValue & _coupled_phi;
